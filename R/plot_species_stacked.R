#' Creates a stacked line graph of ARTIS data by species
#' 
#' This is a function that creates a stacked line plot showcasing seafood trade volumes by species.
#' 
...
#' @return Stacked line graph of ARTIS data by species.
#' @import tidyverse
#' @import countrycode
#' @import viridis
#' @export

plot_species_stacked <- function(data, prop_flow_cutoff = 0.05, 
                                 species = NA, years = NA,
