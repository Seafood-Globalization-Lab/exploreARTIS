#' Creates a line graph of ARTIS data by trade partner
#' 
#' This is a function that creates a line graph showcasing seafood trade volumes by trading partner.
#' 
...
#' @return Line graph of ARTIS data by trade partner.
#' @import tidyverse
#' @import countrycode
#' @import viridis
#' @export
